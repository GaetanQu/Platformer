...
def launch(screen):
    ...
    platforms_list.append(Rect_Platform(screen, (200,200), (1920/2, 750), (0,255,0)))
    platforms_list.append(Rect_Platform(screen, (100, 5), (500, 980), (255,255,255)))
    platforms_list.append(Rect_Platform(screen, (100,5), (700, 850), (255,255,255)))
